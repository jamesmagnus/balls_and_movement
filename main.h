...
enum {S_BOULE_BOUM, S_BOULE_BOULE, S_SORTIE, S_BONUS, S_CLICK, S_SAVE, S_ALARME, S_TOMBE};

enum {CHARGEMENT_ERREUR=-1, CHARGEMENT_REUSSI=0, CHARGEMENT_GAGNE=1, CHARGEMENT_FICHIER_CORROMPU=2};

enum {JEU_FIN_ERREUR_CHARGEMENT=-1, JEU_FIN=0, JEU_EN_COURS=1, JEU_FIN_GAGNE=2};
